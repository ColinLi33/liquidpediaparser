...
pageURL = "https://liquipedia.net/rainbowsix/Evil_Geniuses"
...
def getRosterHistory(rosterDivs):
    ...
    with open('./r6/roster_history.csv', 'w', newline='', encoding='utf-8') as file:
...
def getFirstPlaces(tableRows):
    ...
    with open('./r6/first_places.csv', 'w', newline='') as file:
        writer = csv.writer(file)
...
def getSTierEvents(tableRows):
    ...
    with open('./r6/s_tier_events.csv', 'w', newline='') as file:
        writer = csv.writer(file)
