...
pageURL = "https://liquipedia.net/dota2/Evil_Geniuses"
...
def getRosterHistory(rosterDivs):
    ...
    with open('./dota2/roster_history.csv', 'w', newline='') as file:
...
def getFirstPlaces(tableRows):
    ...
    with open('./dota2/first_places.csv', 'w', newline='') as file:
        writer = csv.writer(file)
...
def getSTierEvents(tableRows):
    ...
    with open('./dota2/s_tier_events.csv', 'w', newline='') as file:
        writer = csv.writer(file)
