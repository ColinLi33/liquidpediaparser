...
pageURL = "https://liquipedia.net/rocketleague/Evil_Geniuses"
...
def getRosterHistory(rosterDivs):
    ...
    with open('./rocketleague/roster_history.csv', 'w', newline='', encoding='utf-8') as file:
...
def getFirstPlaces(tableRows):
    ...
    with open('./rocketleague/first_places.csv', 'w', newline='') as file:
        writer = csv.writer(file)
...
def getSTierEvents(tableRows):
    ...
    with open('./rocketleague/s_tier_events.csv', 'w', newline='') as file:
        writer = csv.writer(file)
